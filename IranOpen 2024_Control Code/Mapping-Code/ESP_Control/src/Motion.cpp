...
int Motion::stanley(){
    ...
    // uart.debug_print("ang: ");
    // uart.debug_print(heading_error);
    // uart.debug_print(" dis: ");
    // uart.debug_println(crosstrack_error);
    ...
    //     reset_filter = false;
    // }
    if(not_abs(steer - last_steer) > 80){   //edit: race
        steer = last_steer;
    }
    last_steer = steer;
