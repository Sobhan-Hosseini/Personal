%{
catchingBallSimulator
Authors: Erfan Amoozad Khalili - Soroosh Keyvanfard
Date: Monday, ‎July ‎10, ‎2023, ‏‎12:29:37 PM
%}
...
%     input(prompt) ;
    ...
    %% Your Code
    delta_F = Kp * error + Kd * (error - last_error) + (Ki * (error + value));
    last_error = error;
    a(1, s) = error;
    s = 1 + s;
    if s == 10
